...
public class TestPerson {
  ...
  public void testInserts() {
    List<Person> personList = Arrays.asList(
        ...
        new Person(ObjectId.get(), "赵六", 23,
            new Address("陕西南路", "上海市", "666666")),
        new Person(ObjectId.get(), "孙七", 24,
            new Address("南京西路", "上海市", "666666")));
  ...
  public void testQuery() {
    this.personCollection.find(eq("name", "张三")).forEach((Consumer<? super Person>) document -> {
  ...
  public void testUpdate() {
    UpdateResult updateResult = this.personCollection.updateMany(eq("name", "张三"), set("age", 22));
    System.out.println(updateResult);
  }

  @Test
  public void  testDelete(){
    DeleteResult deleteResult=this.personCollection.deleteOne(eq("name","张三"));
    System.out.println(deleteResult);
  }

  @Test
  public void  testDeletes(){
    DeleteResult deleteResult=this.personCollection.deleteMany(eq("name","张三"));
    System.out.println(deleteResult);
  }
}
